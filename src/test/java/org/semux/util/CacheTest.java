...
public class CacheTest {
    ...
    public void testPerformance() {
        ...
        logger.info(String.format("Write: LRUMap = %s ns, LRUMap (synchronized) = %s ns, Caffeine = %s ns", t2 - t1, t3 - t2,
                t4 - t3));
        ...
        t4 = System.nanoTime();
        logger.info(String.format("Read: LRUMap = %s ns, LRUMap (synchronized) = %s ns, Caffeine = %s ns", t2 - t1, t3 - t2,
                t4 - t3));
    }

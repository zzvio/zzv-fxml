...
public class BigIntegerUtilTest {
    ...
    private static Logger logger = Logger.getLogger(BigIntegerUtil.class.getName());
    ...
    public void testRandomUniformlyDistributed() {
        ...
        logger.info(String.format("Mean = %s, Expected Mean = %s", mean, expectedMean));
        logger.info(String.format("Deviation = %s, Expected Deviation = %s", deviation, expectedDeviation));

...
public class SemuxBftTest {
    ...
    private static final Logger logger = Logger.getLogger(SemuxBftTest.class.getName());
    ...
    private void testIsPrimaryConsecutiveValidatorProbability(SemuxBft bft) {
        ...
        logger.info(String.format("Consecutive validator probability: %s/%s", repeat, blocks));

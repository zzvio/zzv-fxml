...
public class TransactionResultTest {
    ...
    private static final Logger logger = Logger.getLogger(TransactionResultTest.class.getName());
    ...
    public void testTransactionResultSize() {
        ...
        logger.info(String.format("result size: %s B, %s GB per 1M txs", bytes.length, 1000000.0 * bytes.length / 1024 / 1024 / 1024));
    }

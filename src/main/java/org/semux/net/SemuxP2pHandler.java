...
public class SemuxP2pHandler extends SimpleChannelInboundHandler<Message> {
    ...
    private final static Logger logger = Logger.getLogger(SemuxP2pHandler.class.getName());
    ...
    public void channelActive(ChannelHandlerContext ctx) throws Exception {
        logger.finest(String.format("P2P handler active, remoteIp = %s", channel.getRemoteIp()));
    ...
    public void channelInactive(ChannelHandlerContext ctx) throws Exception {
        logger.finest(String.format("P2P handler inactive, remoteIp = %s", channel.getRemoteIp()));
    ...
    protected void onDisconnect(ChannelHandlerContext ctx, DisconnectMessage msg) {
        ...
        logger.info(String.format("Received a DISCONNECT message: reason = %s, remoteIP = %s",

...
public class ChannelsPresenter {
    ...
    @FXML
    private TableView<ChannelJo> channelsTableView;
    @FXML
    private TableColumn channelInfo;
    private final ObservableList<ChannelJo> itens = FXCollections.observableArrayList();
                ...
                new FloatingActionButton(
                        ...
                        e -> {
                            ...
                            for (final Channel channel : channelList) {
                                ...
                                itens.add(jo);
                                System.out.println("#" + (++i) + " - " + channel + " #block# " + channel.getRemotePeer().getLatestBlockNumber());
                            }
